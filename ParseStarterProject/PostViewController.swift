...
//  Insta(Clone)
//
//  Created by James Daniell on 21/11/2016.
...
class PostViewController: UIViewController, UINavigationControllerDelegate , UIImagePickerControllerDelegate
{
    ...
    {
        activityIndicator = UIActivityIndicatorView(frame: CGRect(x: 0, y: -100, width: 50, height: 50))
        ...
        post.saveInBackground(block: { (success, error ) in
            ...
            else
            {
                ...
                self.imageToPost.image = UIImage(named: "535106-user_512x512.png")
            }
        })
    }
