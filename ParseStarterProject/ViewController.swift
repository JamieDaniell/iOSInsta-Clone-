...
class ViewController: UIViewController
{
    ...
    @IBAction func signupOrLogin(_ sender: Any)
    {
        ...
        else
        {
            ...
            if signupMode
            {
                ...
                user.signUpInBackground(block: { (success,error) in
                    ...
                    if error != nil
                    {
                        ...
                        self.createAlert(title: "Signup Error", message: displayErrorMesage)
                    }
                    else
                    {
            ...
            else
            {
                ...
                PFUser.logInWithUsername(inBackground: emailTextField.text!.lowercased() , password: passwordTextField.text!, block: { (user,error) in
    ...
    override func viewDidLoad()
    {
        ...
        // PFObject = parse frameworks objects
